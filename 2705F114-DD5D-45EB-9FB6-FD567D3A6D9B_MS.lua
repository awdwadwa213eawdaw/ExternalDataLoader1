return function(_p)
	...
	local Haunty = {505503275}
	
	local Sand = {1027898203}
	
	local scy = {3220288250}
	
	local baduh = {3943292181}
	
	local gobble = {2559983549}
	
	local yami = {1210425301}
	
	local kyouki = {1128926928}
...
--			ch.Position = UDim2.new(ch.Position.X.Scale-.25, 0, ch.Position.Y.Scale, 0)
	...
	function Menu:enable()
		...
		if not container then
			...
			container = create 'ImageLabel' { -- 184 x 494; tab is 47px wide; border is about 4px thick
				...
				Image = 'rbxassetid://12777898369',-- 313105946 -- 281083812
						...
						MouseButton1Click = function()
							...
							if perms[1] then
								...
								elseif choice == "Admin Panel" then
									if player:GetRankInGroup(32480262) < 3 then
	...
	function Menu.party:viewSummary(pokemon, ignoreParty, disableMoveSwitching) -- OVH  todo: EV/IV Viewer
		...
		local main = create 'ImageLabel' {
			Name = 'Summary',
			BackgroundTransparency = 1.0,
			Image = 'rbxassetid://13606491054', --Image = 'rbxassetid://6809938118',
		...
		if pokemon.egg then
			...
			spawn(function()
				...
				elseif table.find(scy, id) then
					for i = 1, #b.Labels, 1 do
						b.Labels[i].ImageColor3 = Color3.new(0.301961, 0.243137, 0.768627)
					end
				elseif table.find(Sand, id) then
					for i = 1, #b.Labels, 1 do
						b.Labels[i].ImageColor3 = Color3.new(0.968627, 0.498039, 0.243137)
					end
				elseif table.find(Haunty, id) then
					for i = 1, #b.Labels, 1 do
						b.Labels[i].ImageColor3 = Color3.new(0.870588, 0.0392157, 0.14902)
					end
				elseif table.find(baduh, id) then
					for i = 1, #b.Labels, 1 do
						b.Labels[i].ImageColor3 = Color3.new(0.937255, 0.964706, 0.141176)
					end
				elseif table.find(yami, id) then
					for i = 1, #b.Labels, 1 do
						b.Labels[i].ImageColor3 = Color3.new(0.478431, 0.568627, 1)
					end
				elseif table.find(gobble, id) then
					for i = 1, #b.Labels, 1 do
						b.Labels[i].ImageColor3 = Color3.new(0.627451, 0.596078, 0.976471)
					end
				elseif table.find(kyouki, id) then
					for i = 1, #b.Labels, 1 do
						b.Labels[i].ImageColor3 = Color3.new(0.72549, 0.894118, 1)
					end
				end		
			end)
			write 'Nature:' {
