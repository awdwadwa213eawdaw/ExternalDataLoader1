return function(_p)
	...
	function BattleClient:doPVPBattle(data)
		if self.currentBattle then return end
		local battlethemes = {
			13068230714, -- Tera Raid Battle Theme
			13068190005, -- Mummy Battle
			13059283628, -- Rival Battle
			10841056335, -- Trainer Battle Theme
			13068220429, -- Victini Battle
			13059403407, -- Gym 4 Leader Fight
			13059488774, -- Gym 3 Leader Fight
			13059403407, -- Gym 2 Leader Fight
			13059548674, -- Gym 1 Leader Fight
			13068265042, -- SM Battle Theme
...
--]]
	...
	function BattleClient:setupScene()
		...
		if self.kind ~= 'pvp' and self.kind ~= '2v2' then
			local musicId = self.musicId or {13069298842, 13069301348} -- old: {424133853, 424134350}, really old: 282237556
