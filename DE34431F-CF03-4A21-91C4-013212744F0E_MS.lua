return function(_p)
	...
	_p.Network:bindEvent('depositcell', function()
		PlayerData:addzcell()
	end)
	...
	function PlayerData:getEtc()
		...
		local etc = {
			...
			cellsdeposit = self.cellsdeposit
		...
		if etc.cellsdeposit == nil then etc.cellsdeposit = 0 end
		print("fetching etc, deposit cells: "..tostring(etc.cellsdeposit))
...
--[[
	...
	function PlayerData:loadEtc(etc)
		...
		self.cellsdeposit = etc.cellsdeposit
		print("loaded etc, deposit cells: "..tostring(etc.cellsdeposit))
		local b = {}
